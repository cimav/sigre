...
(function() {
  ...
  Ember.EasyForm.Config.registerTemplate('bootstrap-input', Ember.Handlebars.compile('{{label-field propertyBinding="view.property" textBinding="view.label"}}<div class="{{unbound view.wrapperConfig.controlsWrapperClass}}">{{partial "easyForm/inputControls"}}</div>'));

  Ember.EasyForm.Config.registerWrapper('default', {
    inputTemplate: 'bootstrap-input',
    controlsWrapperClass: 'col-sm-7',
